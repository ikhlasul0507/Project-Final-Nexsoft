                    ...
                    <DivClassSingle className="data-right">
                        ...
                        <DivClassSingle className="form-data">
                            ...
                            <Input type="text" className="input" name=""
                                   disabled={(this.state.disabled) ? "disabled" : ""} placeholder="Product ID..."/>
                        </DivClassSingle>
                        <DivClassSingle className="form-data">
                            <Label>Product Name</Label>
                            <Input type="text" className="input" name=""
                                   disabled={(this.state.disabled) ? "disabled" : ""} placeholder="Product Name..."/>
                        </DivClassSingle>
                        <DivClassSingle className="form-data">
                            <Label className="textarea">Product description</Label>
                            <Textarea name="" className="textarea-input"
                        ...
                        <DivClassSingle className="form-data">
                            ...
                            <Input type="number" className="input" name=""
                                   disabled={(this.state.disabled) ? "disabled" : ""} placeholder="Product price..."/>
                        </DivClassSingle>
