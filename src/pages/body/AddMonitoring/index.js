                ...
                <DivClassSingle className="add">
                    <DivClassSingle className="add-kiri">
                        ...
                        <DivClassSingle className="form-data">
                            ...
                            <Button className="submitA" onClick={() => { if (window.confirm("Are you sure, want to back ?")) { this.props.history.push("/monitoring-produk") } }} ><FaIcons.FaBackward /> Back</Button>
                        </DivClassSingle>
                    </DivClassSingle>
                                ...
                                return (
                                    <DivClassSingle className="add-product" key={index}>
                                        <DivClassSingle className="form-data">
                                            ...
                                            <select className="selectA" value={value.product.idProduct} onChange={event => this.onChangeSelectBarang(event.target.value, index)}>
                                                <option>--Pilih--</option>
                                        ...
                                        <DivClassSingle className="form-data">
                                            ...
                                            <Input type="date" value={value.expiredDate} onChange={event => this.onChangeInput("expiredDate", event.target.value, index)} name="" />
                                        </DivClassSingle>
                                        <DivClassSingle className="form-data">
                                            <Label>Price (Rp)</Label>
                                            <Input type="number" value={value.price} name="" placeholder="Price (Rp)..." onChange={event => this.onChangeInput("price", event.target.value, index)} />
                                        </DivClassSingle>
                                        <DivClassSingle className="form-data">
                                            <Label>Trans Type</Label>
                                            <select className="selectA" value={value.transType} onChange={event => this.onChangeSelectTrans(event.target.value, index)}>
                                                <option>--Pilih--</option>
                                        ...
                                        <DivClassSingle className="form-data">
                                            ...
                                            <Input type="number" value={value.productQuantity} className="inputL" name="" onChange={event => this.onChangeInput("productQuantity", event.target.value, index)} placeholder="Product quantity..." />
                                        </DivClassSingle>
                                        {(index > 0) ?
                                            <>
                                                <Button className="removeProduct" onClick={() => { if (window.confirm("Are you sure, want to delete")) { this.removeChild(index) } }} ><FaIcons.FaMinus /></Button>
                                                <P>Remove</P>
                                            </>
                                            : ""
                                        }
